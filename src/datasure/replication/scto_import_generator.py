...
def _emit_drop_note_fields() -> list[str]:
    ...
    return [
        ...
        "\t* Assuming max 100 note fields, which should be more than enough for any form.",
        "\tforvalues i = 1/100 {",
        '\t\tif "`note_fields`i\'\'" != "" {',
...
def _emit_format_date_fields() -> list[str]:
    ...
    return [
        ...
        "\t* Assuming max 100 date/datetime fields, which should be more than enough for any form.",
...
def _emit_coerce_text_fields() -> list[str]:
    ...
    return [
        ...
        "\t* Assuming max 100 text fields, which should be more than enough for any form.",
