...
def generate_install_packages_script(
    ...
    lines = [
        ...
        "}",
        "",
        "* install ipacheck package",
        "cap which ipacheck",
        "if _rc {",
        '    display "ipacheck package not found. Installing ipacheck..."',
        '    net install ipacheck, all replace from("https://raw.githubusercontent.com/PovertyAction/high-frequency-checks/master") force',
        "}",
        "* Install ipaclean package",
        "cap which ipaclean",
        "if _rc {",
        '    display "ipaclean package not found. Installing ipaclean..."',
        '    net install ipaclean, all replace from("https://raw.githubusercontent.com/PovertyAction/ipaclean/main") force',
        "}",
        "foreach pkg in ipahelper ipaplots {",
        "     cap which `pkg'",
        "     if _rc {",
        "         display \"`pkg' package not found. Installing `pkg'...\"",
        "         github install PovertyAction/`pkg'",
        "     }",
        "}",
