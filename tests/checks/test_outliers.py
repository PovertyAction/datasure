...
from src.checks.outliers import (
...
class TestLoadDefaultSettings:
    ...
    def test_load_default_settings_file_exists(self):
        ...
        with (
            patch("src.checks.outliers.get_check_config_settings") as mock_config,
            patch("src.checks.outliers.os.path.exists") as mock_exists,
            patch("src.checks.outliers.load_check_settings") as mock_load,
        ):
...
class TestOutliersReportSettings:
    ...
    @patch("src.checks.outliers.get_df_info")
    @patch("src.checks.outliers.load_default_settings")
    @patch("src.checks.outliers.find_variable_patterns")
    @patch("src.checks.outliers.show_pattern_selection")
